...
extension String {
    ...
    /// Remove punctuation and lowercase a string
    mutating func sanitize() {
        // This will make an array split by any non letter
    ...
    func isValidPhone() -> Bool {
        var string = self
        string.sanitize() //this might remove the `+` but that's ok since we're normally only interested in the numbers anyway
