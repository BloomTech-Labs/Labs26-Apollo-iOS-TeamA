...
class FetchController {
    ...
    func fetchContextRequest(context: NSManagedObjectContext = CoreDataManager.shared.mainContext) -> [ContextQuestion]? {
    ...
    func fetchQuestionRequest(context: NSManagedObjectContext = CoreDataManager.shared.mainContext) -> [RequestQuestion]? {
    ...
    func fetchQuestions(withTopicId topicId: Int64, on context: NSManagedObjectContext = CoreDataManager.shared.mainContext) -> [RequestQuestion]? {
